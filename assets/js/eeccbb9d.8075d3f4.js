...
const metadata = {
  ...
  "source": "@site/versioned_docs/version-0.72/direct-manipulation.md",
  "sourceDirName": ".",
  "slug": "/direct-manipulation",
  "permalink": "/docs/0.72/direct-manipulation",
  "draft": false,
  "unlisted": false,
  ...
  "previous": {
    "title": "iOS 原生UI组件",
    "permalink": "/docs/0.72/native-components-ios"
  },
  "next": {
    "title": "新架构介绍",
    "permalink": "/docs/0.72/the-new-architecture/landing-page"
  }
};
const assets = {
...
function _createMdxContent(props) {
  ...
  return (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
    children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_the_new_architecture_markdown_native_deprecation_mdx__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .Ay, {}), "\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.p, {
      ...
      children: "清除文本输入框内容是 setNativeProps 的另一个常用方式.当 bufferDely 很低,用户输入很快时,文本输入框的 controlled 参数有时会丢失. 一些开发者偏向于跳过 prop 操作,直接 使用 setNativeProps 来进行文本输入框值的显示操作.下面就是一个按下按钮清除文本输入框内容的例子:"
    }), "\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.div, {
      class: "snack-player",
