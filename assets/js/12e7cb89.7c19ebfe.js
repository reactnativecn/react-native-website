...
const metadata = {
  "id": "build-speed",
  "title": "优化编译速度",
  "description": "构建React Native应用可能会非常昂贵，并且需要开发人员花费数分钟的时间。",
  "source": "@site/versioned_docs/version-0.73/build-speed.md",
  "sourceDirName": ".",
  "slug": "/build-speed",
  "permalink": "/docs/0.73/build-speed",
  "draft": false,
  "unlisted": false,
  ...
  "next": {
    "title": "优化 CI 构建",
    "permalink": "/docs/0.73/speeding-ci-builds"
  }
};
const assets = {
...
const toc = [{
  "value": "仅在开发过程中构建一个ABI（仅适用于Android）",
  "id": "仅在开发过程中构建一个abi仅适用于android",
  "level": 2
}, {
  "value": "使用编译器缓存",
  "id": "使用编译器缓存",
...
function _createMdxContent(props) {
  ...
  return (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
    children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.p, {
      children: ["构建React Native应用可能会非常", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.strong, {
        children: "昂贵"
      ...
      id: "仅在开发过程中构建一个abi仅适用于android",
      children: "仅在开发过程中构建一个ABI（仅适用于Android）"
    }), "\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.p, {
      children: ["在本地构建Android应用程序时，默认情况下会构建所有4个", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.a, {
      ...
      children: "然而，如果您正在本地构建并测试模拟器或物理设备，则可能不需要构建所有这些ABI。"
    }), "\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.p, {
      children: ["这将减少约75％的", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.strong, {
        children: "本机编译时间"
      }), "。"]
    }), "\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.p, {
      children: ["如果您使用React Native CLI，请向 ", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.code, {
        children: "run-android"
      }), " 命令添加 ", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.code, {
        children: "--active-arch-only"
      }), " 标志。此标志将确保从运行的模拟器或插入的手机中选择正确的ABI。要确认此方法是否正常工作，您将在控制台上看到类似于 ", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.code, {
      ...
      children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.p, {
        children: ["以下说明适用于", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.strong, {
          children: "Android和iOS"
        }), "。\n如果您只构建Android应用程序，那么您可以继续进行。\n如果您还要构建iOS应用程序，请按照下面的", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.a, {
      ...
      children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.p, {
        children: ["请注意，这个", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.code, {
          children: "ccache"
        }), "的设置将影响到您在计算机上运行的所有编译过程，不仅限于React Native相关的编译。使用时请自行承担风险。如果您无法安装/编译其他软件，可能是因为这个原因。如果是这种情况，您可以通过以下命令删除所创建的符号链接："]
      }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.pre, {
        children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.code, {
      ...
      children: ["然后你可以进行两次干净的构建（例如在Android上，你可以先运行", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.code, {
      ...
      children: ["为了确保", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.code, {
        children: "ccache"
      }), "在iOS和XCode中正常工作，您需要遵循一些额外的步骤："]
    }), "\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.ol, {
      children: ["\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.li, {
        children: ["您必须修改Xcode和", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.code, {
          children: "xcodebuild"
        }), "调用编译器命令的方式。默认情况下，它们使用_完全指定路径_来调用编译器二进制文件，因此不会使用安装在", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.code, {
          children: "/usr/local/bin"
        }), "中的符号链接。您可以通过以下两种选项之一配置Xcode以使用相对名称来调用编译器："]
      }), "\n"]
      ...
      children: ["\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.li, {
        children: "你需要一个ccache配置，允许一定程度的松散和缓存行为，以便在Xcode编译过程中注册缓存命中。如果通过环境变量进行配置，则与标准不同的ccache配置变量如下："
      }), "\n"]
    }), "\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.pre, {
      children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.code, {
      ...
      }), "文件或任何其他ccache提供的机制中进行配置。更多信息请参阅", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.a, {
      ...
      children: ["\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.li, {
        children: ["\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.p, {
          children: ["在 CI 上，我们建议进行完全清理构建，以避免缓存污染问题。如果按照前面提到的方法进行操作，则应该能够将本机构建并行化为 4 种不同的 ABI，并且很可能不需要在 CI 上使用 ", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.code, {
            children: "ccache"
          }), "。"]
        }), "\n"]
      }), "\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.li, {
      ...
      children: ["我们推荐使用", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.a, {
        ...
        children: "sccache"
      }), "来实现这一目标。\n关于如何设置和使用该工具，请参阅sccache的", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.a, {
