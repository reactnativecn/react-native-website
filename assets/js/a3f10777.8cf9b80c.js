...
// EXTERNAL MODULE: ./versioned_docs/version-0.72/_remove-global-cli.md
var _remove_global_cli = __webpack_require__(31226);
;// CONCATENATED MODULE: ./versioned_docs/version-0.72/_getting-started-linux-android.md
...
function _createMdxContent(props) {
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(_components.h2, {
      ...
      children: (0,jsx_runtime.jsx)(_components.code, {
        className: "language-shell",
        children: "npx react-native@latest init AwesomeProject\n"
      })
    }), "\n", (0,jsx_runtime.jsxs)(_components.p, {
      children: ["如果你是想把 React Native 集成到现有的原生项目中，则步骤完全不同，请参考", (0,jsx_runtime.jsx)(_components.a, {
        href: "/docs/0.72/integration-with-existing-apps",
        children: "集成到现有原生应用"
      }), "。"]
    }), "\n", (0,jsx_runtime.jsx)(_components.h3, {
      id: "可选参数-指定版本或项目模板",
      ...
      children: (0,jsx_runtime.jsx)(_components.code, {
        className: "language-shell",
        children: "npx react-native@X.XX.X init AwesomeProject --version X.XX.X\n"
      })
    }), "\n", (0,jsx_runtime.jsxs)(_components.p, {
      ...
      children: ["你也可以使用 Android 真机来代替模拟器进行开发，只需用 usb 数据线连接到电脑，然后遵照", (0,jsx_runtime.jsx)(_components.a, {
        href: "/docs/0.72/running-on-device",
        children: "在设备上运行"
      }), "这篇文档的说明操作即可。"]
    }), "\n", (0,jsx_runtime.jsx)(_components.h3, {
      id: "使用-android-模拟器",
...
;// CONCATENATED MODULE: ./versioned_docs/version-0.72/_getting-started-macos-android.md
...
function _getting_started_macos_android_createMdxContent(props) {
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(_components.h2, {
      ...
      children: (0,jsx_runtime.jsx)(_components.code, {
        className: "language-shell",
        children: "brew install node@16\nbrew install watchman\n"
      })
    }), "\n", (0,jsx_runtime.jsx)(_components.p, {
      children: "如果你已经安装了 Node，请检查其版本是否在 v16 以上。安装完 Node 后建议设置 npm 镜像（淘宝源）以加速后面的过程（或使用科学上网工具）。"
    }), "\n", (0,jsx_runtime.jsxs)(_components.blockquote, {
      children: ["\n", (0,jsx_runtime.jsx)(_components.p, {
        children: "注意：强烈建议始终选择 Node 当前的 LTS （长期维护）版本，一般是偶数版本，不要选择偏实验性质的奇数版本。"
      }), "\n"]
...
;// CONCATENATED MODULE: ./versioned_docs/version-0.72/_getting-started-windows-android.md
...
function _getting_started_windows_android_createMdxContent(props) {
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(_components.h2, {
      ...
      children: "注意 Node 的版本应大于等于 16，安装完 Node 后建议设置 npm 镜像（淘宝源）以加速后面的过程（或使用科学上网工具）。"
    }), "\n", (0,jsx_runtime.jsxs)(_components.blockquote, {
      children: ["\n", (0,jsx_runtime.jsx)(_components.p, {
        children: "注意：强烈建议始终选择 Node 当前的 LTS （长期维护）版本，一般是偶数版本，不要选择偏实验性质的奇数版本。"
      }), "\n"]
...
;// CONCATENATED MODULE: ./versioned_docs/version-0.72/_getting-started-macos-ios.md
...
;// CONCATENATED MODULE: ./versioned_docs/version-0.72/getting-started.md
...
const metadata = {
  ...
  "source": "@site/versioned_docs/version-0.72/getting-started.md",
  "sourceDirName": ".",
  ...
  "next": {
    "title": "集成到现有原生应用",
    "permalink": "/docs/0.72/integration-with-existing-apps"
  }
};
const assets = {
