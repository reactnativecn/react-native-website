...
const metadata = {
  ...
  "source": "@site/versioned_docs/version-0.71/animations.md",
  "sourceDirName": ".",
  "slug": "/animations",
  ...
  "previous": {
    "title": "使用导航器跳转页面",
    "permalink": "/docs/0.71/navigation"
  },
  "next": {
    "title": "手势响应系统",
...
function _createMdxContent(props) {
  ...
  return (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
    children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.p, {
      ...
      children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.code, {
        children: "Animated"
      }), "的 API 是可序列化的（即可转化为字符串表达以便通信或存储）。通过启用", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.a, {
        href: "http://facebook.github.io/react-native/blog/2017/02/14/using-native-driver-for-animated.html",
        children: "原生驱动"
      }), "，我们在启动动画前就把其所有配置信息都发送到原生端，利用原生代码在 UI 线程执行动画，而不用每一帧都在两端间来回沟通。如此一来，动画一开始就完全脱离了 JS 线程，因此此时即便 JS 线程被卡住，也不会影响到动画了。"]
    }), "\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.p, {
      ...
      }), " 查看本机驱动程序的运行情况，然后再载入原生动画示例。您也可以查看 ", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.a, {
      ...
      children: ["本机驱动程序目前并不足以支持您使用 ", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.code, {
        children: "Animated"
      ...
      children: ["如果你发现你的动画丢帧（低于 60 帧每秒），可以尝试使用", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.code, {
        ...
        children: "shouldComponentUpdate"
      }), "来优化它们。Or you could run the animations on the UI thread rather than the JavaScript thread ", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.a, {
        href: "http://facebook.github.io/react-native/blog/2017/02/14/using-native-driver-for-animated.html",
        children: "with the useNativeDriver option"
      }), ". 你还可以考虑将部分计算工作放在动画完成之后进行，这时可以使用", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.a, {
