...
const metadata = {
  ...
  "source": "@site/versioned_docs/version-0.72/handling-text-input.md",
  "sourceDirName": ".",
  "slug": "/handling-text-input",
  "permalink": "/docs/0.72/handling-text-input",
  "draft": false,
  "unlisted": false,
  ...
  "next": {
    "title": "使用滚动视图",
    "permalink": "/docs/0.72/using-a-scrollview"
  }
};
const assets = {
