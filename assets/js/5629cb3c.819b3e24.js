...
const metadata = {
  ...
  "source": "@site/../cndocs/legacy/native-modules-ios.md",
  "sourceDirName": "legacy",
  "slug": "/legacy/native-modules-ios",
  "permalink": "/docs/next/legacy/native-modules-ios",
  "draft": false,
  "unlisted": false,
  "editUrl": "https://github.com/reactnativecn/react-native-website/blob/production/cnwebsite/../cndocs/legacy/native-modules-ios.md",
  "tags": [],
  "version": "current",
  "frontMatter": {
    "id": "native-modules-ios",
  ...
  "next": {
    ...
    "permalink": "/docs/next/legacy/native-modules-setup"
  }
};
const assets = {
...
function _createMdxContent(props) {
  ...
  return (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
    children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_the_new_architecture_markdown_native_deprecation_mdx__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .Ay, {}), "\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.p, {
      ...
      children: ["原生模块通常作为 npm 包进行分发，只是要成为原生模块，它们将包含一个 Xcode 库项目。要获得基本的框架，请务必先阅读", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.a, {
      ...
      children: ["如果您重写 ", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.code, {
        children: "- constantsToExport"
      }), "，那么您也应该实现 ", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.code, {
        children: "+ requiresMainQueueSetup"
      }), "，以便让 React Native 知道您的模块是否需要在主线程上初始化。否则，您将会看到一个警告：在未来，除非您明确选择退出使用 ", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.code, {
        children: "+ requiresMainQueueSetup"
      }), "，否则您的模块可能会在后台线程上进行初始化。"]
    }), "\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.pre, {
      children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.code, {
        className: "language-objectivec",
      ...
      children: ["\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components.p, {
        children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.strong, {
          children: "在制作第三方模块时的重要注意事项"
        }), ": 只有 Xcode 9 及更高版本才支持在静态库中使用 Swift。为了在使用包含在模块中的 iOS 静态库中的 Swift 时构建 Xcode 项目，您的主应用程序项目必须包含 Swift 代码和桥接头文件本身。如果您的应用程序项目不包含任何 Swift 代码，则解决方法可以是一个空的 .swift 文件和一个空的桥接头。"]
      }), "\n"]
      ...
      children: ["在 iOS 上，原生模块可以通过实现 ", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.code, {
        children: "invalidate"
      }), " 方法来符合 ", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.a, {
      ...
      }), " 协议。当本地桥接被失效时（例如：开发模式重新加载），可以调用这个方法", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.a, {
        ...
        children: "链接"
      }), "。通常情况下，您应避免实现此方法，因为这种机制是为了向后兼容而存在的，未来可能会被移除。"]
    })]
  });
}
