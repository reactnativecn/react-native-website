...
const metadata = {
  ...
  "source": "@site/architecture/architecture-glossary.md",
  "sourceDirName": ".",
  "slug": "/glossary",
  "permalink": "/architecture/glossary",
  "draft": false,
  "unlisted": false,
  "editUrl": "https://github.com/reactnativecn/react-native-website/blob/production/cnwebsite/architecture/architecture-glossary.md",
  "tags": [],
  "version": "current",
  "frontMatter": {
    "id": "architecture-glossary",
...
function _createMdxContent(props) {
  ...
  return (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
    children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.h2, {
      ...
      children: ["React Native 执行的 React 框架代码，和 React 在 Web 中执行代码是同一份。但是，React Native 渲染的是通用平台视图（宿主视图）而不是 DOM 节点（可以认为 DOM 是 Web 的宿主视图）。 Fabric 渲染器使得渲染宿主视图变得可行。Fabric 让 React 与各个平台直接通信并管理其宿主视图实例。 Fabric 渲染器存在于 JavaScript 中，并且它调用的是由 C++ 代码暴露的接口。在", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.a, {
      ...
      children: ["宿主视图树就是一系列的宿主视图。宿主平台有 Android 平台、iOS 平台等等。在 Android 上，宿主视图就是 ", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.code, {
      ...
      children: "Java Native Interface (JNI)：一个用于在 Java 中写 原生(译注：指调用 C++) 方法的 API。作用是实现 Fabric 的 C++ 核心和 Android 的通信。"
    }), "\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.h2, {
      id: "react-组件react-component",
      ...
      children: "React 组件的 render 方法中，包括其他 React 复合组件和 React 宿主组件。"
    }), "\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.h2, {
      id: "react-宿主组件react-host-components-or-host-components",
      ...
      children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.em, {
        children: "Yoga 树"
      }), " 被 ", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.a, {
        href: "https://yogalayout.com/",
        children: "Yoga"
      }), " 使用来计算 React 影子树的布局信息。每个 React 影子节点通常创建一个 ", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.em, {
        children: "Yoga 节点"
      }), "，因为 React Native 使用 Yoga 来计算布局。然而，这不是硬性要求。Fabric 也可以创建不使用 Yoga 的 React 影子节点；每个 React 影子节点的实现决定了如何计算布局。"]
    })]
  });
}
