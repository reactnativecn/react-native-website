...
;// CONCATENATED MODULE: ./versioned_docs/version-0.72/_integration-with-existing-apps-java.md
...
;// CONCATENATED MODULE: ./versioned_docs/version-0.72/_integration-with-existing-apps-objc.md
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(_components.h2, {
      ...
      children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
        ...
        }), " 会启动一个新的 JSC VM。为了节省资源并简化本机应用程序中不同部分的 RN 视图之间的通信，您可以拥有多个由 React Native 提供支持且与单个 JS 运行时相关联的视图。要实现这一点，请使用 ", (0,jsx_runtime.jsx)(_components.a, {
...
;// CONCATENATED MODULE: ./versioned_docs/version-0.72/_integration-with-existing-apps-swift.md
...
function _integration_with_existing_apps_swift_createMdxContent(props) {
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(_components.h2, {
      ...
      children: ["安装Xcode命令行工具。在Xcode菜单中选择", (0,jsx_runtime.jsx)(_components.strong, {
        children: "Settings... (或者是 Preferences...)"
      }), "，进入 Locations 面板并通过在 Command Line Tools 下拉菜单中选择最新版本来安装工具。"]
    }), "\n", (0,jsx_runtime.jsx)(_components.p, {
      children: (0,jsx_runtime.jsx)(_components.img, {
      ...
      children: "我们将把React Native组件与名为“RCTRootView”的新原生视图绑定在一起，该视图实际上包含它。"
    }), "\n", (0,jsx_runtime.jsx)(_components.h5, {
      id: "1-创建一个事件路径",
      children: "1. 创建一个事件路径"
    }), "\n", (0,jsx_runtime.jsx)(_components.p, {
      ...
      children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
        ...
        }), "会启动一个新的JSC VM。为了节省资源并简化本机应用程序中不同部分的RN视图之间的通信，您可以拥有由React Native驱动的多个视图与单个JS运行时相关联。要做到这一点，而不是使用 ", (0,jsx_runtime.jsx)(_components.code, {
          children: "RCTRootView bundleURL"
      ...
      children: ["\n", (0,jsx_runtime.jsx)(_components.p, {
        children: "其中一种更简单的方法是在Storyboard中打开视图，右键单击新链接。选择诸如“Touch Up Inside”事件之类的内容，将其拖到Storyboard上，然后从提供的列表中选择所创建的方法。"
      }), "\n"]
    }), "\n", (0,jsx_runtime.jsx)(_components.h3, {
      id: "测试集成结果",
      children: "测试集成结果"
      ...
      children: "这是应用_React Native_部分的 high score 页面:"
    }), "\n", (0,jsx_runtime.jsx)(_components.p, {
      children: (0,jsx_runtime.jsx)(_components.img, {
        alt: "High Scores",
        src: (__webpack_require__(48777)/* ["default"] */ .A) + "",
...
;// CONCATENATED MODULE: ./versioned_docs/version-0.72/_integration-with-existing-apps-kotlin.md
...
;// CONCATENATED MODULE: ./versioned_docs/version-0.72/integration-with-existing-apps.md
...
const metadata = {
  ...
  "source": "@site/versioned_docs/version-0.72/integration-with-existing-apps.md",
  "sourceDirName": ".",
  ...
  "next": {
    ...
    "permalink": "/docs/0.72/integration-with-android-fragment"
  }
};
const assets = {
