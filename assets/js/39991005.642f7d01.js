...
const metadata = {
  ...
  "source": "@site/versioned_docs/version-0.72/new-architecture-app-renderer-android.md",
  "sourceDirName": ".",
  "slug": "/new-architecture-app-renderer-android",
  "permalink": "/docs/0.72/new-architecture-app-renderer-android",
  "draft": false,
  "unlisted": false,
  ...
  "previous": {
    ...
    "permalink": "/docs/0.72/new-architecture-app-modules-ios"
  },
  "next": {
    "title": "在 iOS 上启用 Fabric",
    "permalink": "/docs/0.72/new-architecture-app-renderer-ios"
  }
};
const assets = {
