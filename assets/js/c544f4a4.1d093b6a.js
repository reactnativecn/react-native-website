...
const metadata = {
  ...
  "title": "核心组件与原生组件",
  "description": "React Native 使用完全原生的组件来构建应用界面。尤其方便的是它已经内置了大量直接上手可用的核心组件。",
  "source": "@site/versioned_docs/version-0.73/intro-react-native-components.md",
  "sourceDirName": ".",
  "slug": "/intro-react-native-components",
  "permalink": "/docs/0.73/intro-react-native-components",
  "draft": false,
  "unlisted": false,
  ...
  "previous": {
    "title": "简介",
    "permalink": "/docs/0.73/getting-started"
  },
  "next": {
    "title": "React 基础",
    "permalink": "/docs/0.73/intro-react"
  }
};
const assets = {
